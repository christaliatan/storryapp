...
import com.dicoding.picodiploma.loginwithanimation.view.story.createFile
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                override fun onError(exc: ImageCaptureException) {
                    Toast.makeText(this@CameraActivity, exc.localizedMessage, Toast.LENGTH_SHORT).show()
                }
